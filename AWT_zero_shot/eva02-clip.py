...
def evaluate(val_loader, model, text_features, args):
    ...
    with open(f'./results/eva/all.txt', 'a') as f:
...
def main_worker(args):
    ...
    #     'EVA02-B-16',
    #     pretrained='/mnt/petrelfs/zhaozhiyu/zhuyuhan/.clip_ckpt/eva02_base_patch16_clip_224.merged2b_s8b_b131k/open_clip_pytorch_model.bin'
    # )
    # tokenizer = open_clip.get_tokenizer('EVA02-B-16')
    model, _, preprocess = open_clip.create_model_and_transforms('hf-hub:timm/eva02_base_patch16_clip_224.merged2b_s8b_b131k')
    tokenizer = open_clip.get_tokenizer('hf-hub:timm/eva02_base_patch16_clip_224.merged2b_s8b_b131k')
    model = model.cuda()
